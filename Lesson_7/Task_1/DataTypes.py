...
class DataType:
    ...
    def first_name(self,first):
        self._driver.find_element(By.CSS_SELECTOR, "[name='first-name']").send_keys(first)

    def last_name(self,last):
        self._driver.find_element(By.CSS_SELECTOR, "[name='last-name']").send_keys(last)
        
    def address(self,address):
        self._driver.find_element(By.CSS_SELECTOR, "[name='address']").send_keys(address)

    def zip_code(self,zipcode):
        self._driver.find_element(By.CSS_SELECTOR, "[name='zip-code']").send_keys(zipcode)
